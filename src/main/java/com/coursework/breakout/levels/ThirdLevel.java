...
public class ThirdLevel  extends Level {
    public ThirdLevel(SceneGame sceneGame) {
        super(sceneGame);
    }
    @Override
    ...
    public List<Rectangle> addObstacles() {
        ...
        Rectangle obstacle = createRectangle(50);
        obstacles.add(obstacle);
        sceneGame.addElement(obstacle);
        obstacle = createRectangle(200);
        obstacles.add(obstacle);
        sceneGame.addElement(obstacle);
        obstacle = createRectangle(340);
        obstacles.add(obstacle);
        sceneGame.addElement(obstacle);
        obstacle = createRectangle(490);
        obstacles.add(obstacle);
        sceneGame.addElement(obstacle);
